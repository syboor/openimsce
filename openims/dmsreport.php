...
include (getenv ("DOCUMENT_ROOT")."/nkit/nkit.php");
  ...
  SHIELD_NeedsGlobalRight (IMS_SuperGroupName(), "preview");
  $params = SHIELD_Decode ($params);

  if ($params["type"]=="snapshot") {
    echo REPORTS_Selected ($params["type"], false, false);
  } else {
    echo REPORTS_Selected ($params["type"], true, false);
  }
?>