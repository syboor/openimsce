...
die(); // Since this file may already have been pushed to customers, make it die().  
       // But in the future, simply DO NOT USE THE .PHP EXTENSION for scripts that should not be executable!!!
