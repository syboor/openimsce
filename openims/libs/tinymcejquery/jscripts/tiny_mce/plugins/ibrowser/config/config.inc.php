<?php
	...
	//-------------------------------------------------------------------------	
	$cfg['lang']   		= 'nl';														// default language; e.g. 'en'		
  ...
  $cfg['ilibs_dir']      = array('/tinymce/jscripts/tiny_mce/plugins/ibrowser/img/');               // image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
...
// NDV MRT 03 2013 - Use alternate temp dir
if (!file_exists ($_SERVER["DOCUMENT_ROOT"] . '/tmp/tinymce')) mkdir ($_SERVER["DOCUMENT_ROOT"] . '/tmp/tinymce');
$cfg['temp'] = realpath($_SERVER["DOCUMENT_ROOT"] . '/tmp/tinymce');
