<?php
	...
	include (getenv ("DOCUMENT_ROOT"). "/nkit/nkit.php");
        ...
        $decodedsettings = SHIELD_Decode($_REQUEST["encodedsettings"]);
        SHIELD_RequireLogon($sgn);

	//get image path
	$image_dir = $_GET['img_path'];
        if ($image_dir != $decodedsettings['imagepath']) N_Die("Security violation");
	$taal = $_GET['taal'];
	$temp = substr($image_dir, -11) ;
	
	//create dir if necessary
	if ($temp != "page_files/" and $temp != "_bestanden/") {
		if($taal == "nl") {
			N_WriteFile ("html::$image_dir"."/page_bestanden/dummy.txt", "dummy");
			N_DeleteFile ("html::$image_dir"."/page_bestanden/dummy.txt");

			$image_dir = $image_dir."page_bestanden/";
		}
		else {
			N_WriteFile ("html::$image_dir"."/page_files/dummy.txt", "dummy");
			N_DeleteFile ("html::$image_dir"."/page_files/dummy.txt");
			$image_dir = $image_dir."page_files/";
		}
	}
	// ================================================
	...
	//-------------------------------------------------------------------------
	// language settings	
	// KM/30/03/2008: Regel gewijzigd zodat hij de taal instellingen van OpenIMS overneemt. Origineel: $l = (isset($_REQUEST['lang']) ? new PLUG_Lang($_REQUEST['lang']) : new PLUG_Lang($cfg['lang']));
	$l = (isset($taal) ? new PLUG_Lang($taal) : new PLUG_Lang($cfg['lang']));
	$l->setBlock('ibrowser');	
	//-------------------------------------------------------------------------
...
<form id="iBrowser" name="iBrowser" method="post" action="scripts/rfiles.php" enctype="multipart/form-data" target="inSelFrame">
  ...
  <input type="hidden" name="encodedsettings" value="<?php echo htmlspecialchars($_REQUEST["encodedsettings"]); ?>" />
  ...
  <div id="outerDivWrap">
    ...
    <div class="brdPad">
      <!- MAIN MENU --------------------------------------------------------- -->
      <div id="menuDivWrap" class="hideit">
        <div class="headerDiv">
          <?php echo $l->m('im_003'); ?>
        </div>
        <div class="brdPad">
        ...
        <div class="brdPad">
          <div id="mainDiv">
            ...
            <div id="inDiv" class="showit">
                ...
                <div class="colLeft">
                  <div style="float: left;">
                    ...
                    <div class="rowDiv">
                      ...
                      <div id="inSelDiv">
                        <iframe name="inSelFrame" id="inSelFrame" src="scripts/rfiles.php?clib=<?php echo $clib; ?>&encodedsettings=<?php echo htmlspecialchars($_REQUEST["encodedsettings"]); ?>" style="width: 100%; height: 100%;" scrolling="no" marginheight="0" marginwidth="0" frameborder="0"></iframe>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <!- // colRight -->
              <!- random section --------------------------------------------------- -->
              <?php /* KM/30/03/2009: De div "raDiv" de classe hideit gegeven in plaats van showit */ ?>
              <div id="raDiv" class="hideit">
                <div class="mbottom5">
                  <div class="rowDiv">
                    <div class="btnRight">
                    </div>
                    <label> <span class="title"> <?php echo $l->m('in_053'); ?> </span> </label>
                    <div class="hideit"><input name="chkRandom" id="chkRandom" type="checkbox" value="" class="chkBox" />
              ...
              <div id="fileDivWrap" class="showit">
                <div class="rowDiv">
                  <div class="btnRight">
                    ...
                    <?php /* KM/30/03/2009: Condities toegevoegd die er voor zorgt dat ook verwijderen en hernoemen getoond word als dat is ingesteld in de site config. */ ?>
				    <img src="images/dir_off.gif" onClick="changeClass(0,'fileDiv','showit','fiDirDiv','showit','fiUplDiv','hideit','fiRenDiv','<?php echo (($myconfig[IMS_SuperGroupName()]['ibrowser']['showrename'] == "yes") ? "showit" : "hideit") ?>','fiDelDiv','<?php echo (($myconfig[IMS_SuperGroupName()]['ibrowser']['showdelete'] == "yes") ? "showit" : "hideit") ?>');" onMouseOver="this.src='images/dir.gif';" onMouseOut="this.src='images/dir_off.gif';" alt="<?php echo $l->m('in_027'); ?>" title="<?php echo $l->m('in_027'); ?>" width="16" height="16" />
                    <?php }; ?>
                    <?php if ($cfg['upload']) {; ?>
                    <?php /* KM/30/03/2009: Condities toegevoegd die er voor zorgt dat ook verwijderen en hernoemen getoond word als dat is ingesteld in de site config. */ ?>
                    <img src="images/upimg_off.gif" onClick="changeClass(1,'fileDiv','showit','fiDirDiv','hideit','fiUplDiv','showit','fiRenDiv','<?php echo (($myconfig[IMS_SuperGroupName()]['ibrowser']['showrename'] == "yes") ? "showit" : "hideit") ?>','fiDelDiv','<?php echo (($myconfig[IMS_SuperGroupName()]['ibrowser']['showdelete'] == "yes") ? "showit" : "hideit") ?>');" onMouseOver="this.src='images/upimg.gif';" onMouseOut="this.src='images/upimg_off.gif';" alt="<?php echo $l->m('in_019'); ?>" title="<?php echo $l->m('in_019'); ?>" width="16" height="16" />
                    <?php }; ?>
                  ...
                  <?php /* KM/30/03/2009: width:300px toegevoegd en een conditie voor de label tekst*/ ?>
                  <label style="width:300px;"> <span class="title">
                  	<?php
                  		if ($myconfig[IMS_SuperGroupName()]['ibrowser']['showrename'] == "yes" && $myconfig[IMS_SuperGroupName()]['ibrowser']['showdelete'] == "yes") {
                  			echo $l->m('in_066'); 
                  		} elseif ($myconfig[IMS_SuperGroupName()]['ibrowser']['showrename'] == "yes") {
                  			echo $l->m('in_065'); 
                  		} elseif ($myconfig[IMS_SuperGroupName()]['ibrowser']['showdelete'] == "yes") {
                  			echo $l->m('in_064'); 
                  		} else {
                  			echo $l->m('in_063'); 
                  		}
                ...
                <div id="fileDiv" class="showit">
                  ...
                  <div id="fiDelDiv" class="hideit">
                    <?php /* KM/30/03/2009: fileDivWrap toegevoegd met label "verwijderen" */ ?>
                    <div id="fileDivWrap" class="showit">
  					  <div class="rowDiv">&nbsp;<br/>
  						<label>
  							<span class="title"><?php echo $l->m('in_067'); ?></span>
  						</label>
  					  </div>
				    </div>
                    <div class="rowDiv">
                  ...
                  <div id="fiRenDiv" class="hideit">
                    <?php /* KM/30/03/2009: fileDivWrap toegevoegd met label "hernoemen" */ ?>
                    <div id="fileDivWrap" class="showit">
  					  <div class="rowDiv">&nbsp;<br/>
  						<label>
  							<span class="title"><?php echo $l->m('in_016'); ?></span>
  						</label>
  					  </div>
				    </div>
                    <div class="rowDiv">
                  ...
                  <div id="fiUplDiv" class="hideit">
                    <?php /* KM/30/03/2009: fileDivWrap toegevoegd met label "uploaden" */ ?>
                    <div id="fileDivWrap" class="showit">
  					  <div class="rowDiv">&nbsp;<br/>
  						<label>
  							<span class="title"><?php echo $l->m('in_068'); ?></span>
  						</label>
  					  </div>
				    </div>
                    <div class="rowDiv">
